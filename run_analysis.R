...
X_train <- read.table("Samsung data/UCI HAR Dataset/train/X_train.txt", quote="\"")

y_train <- read.table("Samsung data/UCI HAR Dataset/train/y_train.txt", quote="\"")

subject_train <- read.table("Samsung data/UCI HAR Dataset/train/subject_train.txt", quote="\"")

##reading all testing data
X_test <- read.table("Samsung data/UCI HAR Dataset/test/X_test.txt", quote="\"")

y_test <- read.table("Samsung data/UCI HAR Dataset/test/y_test.txt", quote="\"")

subject_test <- read.table("Samsung data/UCI HAR Dataset/test/subject_test.txt", quote="\"")


##reading features
features <- read.table("Samsung data/UCI HAR Dataset/features.txt", quote="\"")

##reading actvity labels
act_labels <- read.table("Samsung data/UCI HAR Dataset/activity_labels.txt", quote="\"")
